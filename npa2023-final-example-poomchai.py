#######################################################################################
# FirstName/Surname: Poomchai Udomsin
# Student ID: 65070178
...
accessToken = "Bearer ZjNjMDE2MjAtODE1NS00MTc5LWFjZmItMWY0MTJhZThiMWRhMTQ1MDJiMzAtNzBi_P0A1_1ad92174-dfe2-4740-b008-57218895946c" 
...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    if message.find("/poomchai_lnwza") == 0:
